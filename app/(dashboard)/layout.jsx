  ...
  return (
    <ProtectedRoute>
      <div className="flex h-screen bg-gray-50 overflow-hidden">
        ...
        <aside className="hidden md:flex w-72 flex-col bg-white  md:justify-center dark:bg-gray-900">
          <Sidebar />
        </aside>

        <div className="flex flex-1 flex-col relative overflow-hidden dark:bg-gray-900">
          {/* 
          Main Scrollable Content:
          - pb-24: Extra space on mobile for the BottomTabBar
          - md:pb-6: Normal spacing on desktop since the bar is hidden
        */}
          <main className="flex-1 overflow-y-auto px-4 py-6 pb-24 md:pb-6 dark:bg-gray-900 rounded">
            {children}
          </main>
